...
CREATE TABLE `teamboard` (
  ...
  `teamNo` varchar(10) NOT NULL,
  `writeId` varchar(10) NOT NULL,
  ...
  `fileJoinDate` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`fileNo`),
  KEY `WriteId` (`writeId`),
  KEY `TeamNumber` (`teamNo`)
...
-- Dump completed on 2018-02-20  1:26:11
